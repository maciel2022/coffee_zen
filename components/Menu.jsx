      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos fugiat voluptas dolores corporis necessitatibus quos vero dolore a? Totam odio sed sint dolorum repudiandae! Quibusdam tempora consequatur dignissimos esse quod.
          </p>
        </div>
        {/* menu & btn */}
        <div className="flex flex-col items-center gap-12 xl:gap-24">
          ...
          <button  className="btn">View a full menu</button>
        </div>
      </div>
    </section>
  )
