...
const OpeningHours = () => {
  return (
    <section className="flex bg-primary h-[60vh] xl:h-[80vh]">
        ...
        {/* 2 */}
        <div className="flex-1 bg-opening_hours bg-cover bg-no-repeat flex justify-center items-center relative">
            {/* overlay */}
            <div className="h-full w-full absolute top-0 bg-black/[0.85] z-10"></div>
            {/* text & images */}
